...
* Sequence to sequence models - Machine Translation. NLG tasks. Applications include generating a caption based on an image , text based on a table, and a description based on source code changes.   Generate an output sequence by predicting one word at a time. For continuency parsing and Named Entity recognition. Transformer https://jalammar.github.io/visualizing-neural-machine-translation-mechanics-of-seq2seq-models-with-attention/
