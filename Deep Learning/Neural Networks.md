...
* Problem1: Gradients can Vanish <br/>
  ...
  * Solution: a) Use non saturating non-linear activation functions such as ReLUs, ELUs, etc; b) Parameter initialization - Initialize weights to Identity matrix & Biases to 0. This prevents the weights from shrinking to 0  c) LSTM, GRU <br/>
